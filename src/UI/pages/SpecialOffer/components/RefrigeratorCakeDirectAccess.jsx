...
import { specialOffer_apiCalls } from "../../../../core/services/agent";
...
const RefrigeratorCakeDetails = ({ id }) => {
    ...
    >
      ...
      {hasError && (
        <div className="w-100 d-flex justify-content-center align-items-center">
          <Alert className="w-100" severity="warning">متاسفانه کیکی یافت نشد!!</Alert>
        </div>
      )}
    </section>
  );
