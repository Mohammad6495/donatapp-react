...
import "./CreamyCookieDetailsItem.scss";

const CreamyCookieDetailsItem = ({
  itemId,
  itemSelectNumber,
  handleDeletingItem,
  itemName,
  ...
  return (
    <div className="d-flex justify-content-between align-items-center w-100 item-container p-2 my-2">
...
export default CreamyCookieDetailsItem;
